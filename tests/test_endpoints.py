...
from constants.message_strings import (DEVICE_HAS_NO_REGISTERED_TOKEN, MESSAGE_SEND_FAILED_UNKNOWN,
    ...
    MFA_SELF_SUCCESS, MFA_TEST_DISABLED, MFA_TEST_FAIL, MFA_TEST_SUCCESS, NO_DELETION_PERMISSION,
    PARTICIPANT_LOCKED, PASSWORD_RESET_FAIL_SITE_ADMIN, PUSH_NOTIFICATIONS_NOT_CONFIGURED)
