...
from constants.message_strings import (DEVICE_HAS_NO_REGISTERED_TOKEN, MESSAGE_SEND_FAILED_UNKNOWN,
    MESSAGE_SEND_SUCCESS, MFA_CODE_6_DIGITS, MFA_CODE_DIGITS_ONLY, MFA_CODE_MISSING,
    MFA_RESET_BAD_PERMISSIONS, MFA_SELF_BAD_PASSWORD, MFA_SELF_DISABLED, MFA_SELF_NO_PASSWORD,
    MFA_SELF_SUCCESS, MFA_TEST_DISABLED, MFA_TEST_FAIL, MFA_TEST_SUCCESS, NEW_PASSWORD_MISMATCH,
    NEW_PASSWORD_N_LONG, NEW_PASSWORD_RULES_FAIL, NO_DELETION_PERMISSION, PARTICIPANT_LOCKED,
    PASSWORD_RESET_FAIL_SITE_ADMIN, PASSWORD_RESET_SUCCESS, PUSH_NOTIFICATIONS_NOT_CONFIGURED,
